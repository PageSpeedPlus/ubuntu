...
# Last Modify: 2018-08-06
# https://github.com/VirtuBox/ubuntu-nginx-web-server/blob/master/scripts/init.sh 
# https://raw.githubusercontent.com/VirtuBox/ubuntu-nginx-web-server/master/scripts/init.sh
